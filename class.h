...
public:
    ...
    //FTransform ComponentToWorld; //坐标
...
public:
    ...
    char pa_00198[0x100];
    class APlayerState* PlayerState;  //玩家状态偏移0x298
...
class APlayerState  //玩家属性
{
public:
    char pa_0000[0x0002F0];
    class  AActor* PawnPrivate; //本人玩家
...
public:
    ...
    AItem_Weapon_General* CurrentWeapon; //当前武器
};
class AGmeStateBase
{
public:
